...
Fire is understood to be a natural and recurrent earth system process, contributing to the delineation of ecological boundaries, influencing geological cycles, and affecting atmospheric dynamics. These effects can be seen in ecoregions shaped on fire adaptation, fire effects on soil properties, and carbon released into the climate system ([[Fire_in_Earth_System.pdf#page=2&selection=76,0,81,13&color=yellow|1]], [[Harrison_2021_Environ._Res._Lett._16_125008.pdf#page=3&selection=190,7,225,6&color=yellow|2]], [[Wildfire_as_a_hydrological_Shakesby.pdf#page=1&selection=10,0,14,59&color=yellow|10]]).
...
Fire takes three elements in order to occur: heat, oxygen, and fuel. As we move forward in space and time, these elements change and vary with scale. In order to visualize the three fire fundamental elements, a triangle is often used. To better exemplify the change of these elements with scale as we discuss wildfires, Cochrane and Ryan 2009 proposed the following figure:
