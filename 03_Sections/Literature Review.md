...
Although there are different approaches and definitions, wildfires are widely understood as "any unplanned and uncontrolled fire started in shrubs or forest" ([[The_Dilemma_of_Wildfire_Definition.pdf#page=2&selection=4,0,5,59&color=yellow|11]]). There is no distinction based on the source of ignition, so these fires can be naturally, intentionally, or accidentally set ([[Fire_Ecology.pdf#page=74&selection=32,0,34,61&color=yellow|13]]). Usually, natural causes of ignitions are lightnings and in rare cases caused by spontaneous ignitions ([[Introduction_to_Wildland_fire.pdf#page=27&selection=401,0,419,26&color=yellow|12]]). 
